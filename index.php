...
<div id="carouselId" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item <?php if($no == '1'){ echo 'active';}?>">
            <img src="assets/image/<?= $gambar['wisata'];?>" alt="First slide" 
            class="img-fluid mx-auto d-block" style="object-fit:cover;width:auto;height:400px;">
        </div>
        <?php $no++;}?>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            <div class="row">
                ...
                <br/>
                <style>
                    .col-sm-4 {max-width: 50px; max-height: 1000px; /* Sesuaikan nilai ini sesuai kebutuhan Anda */}
                </style>
                <div class="col-sm-4" >
                    <div class="card">
